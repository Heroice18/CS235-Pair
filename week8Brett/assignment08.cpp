...
int main()
{
    ...
    // MY test code
//    BNode<int>* brett = new BNode<int>(1);
//    BNode<int>* brettM = new BNode<int>(3);
//    BNode<int>* brettMills = new BNode<int>(4);
//    addLeft(brett, 2);
//    addLeft(brett->pLeft, brettMills);
//    addRight(brett, brettM);
//    cout << brett << endl;
//    BNode<int>* copyBrett;
//    copyBrett = brett;
//    cout << copyBrett << endl;
//    cout << sizeBTree(copyBrett) << endl;
//    deleteBTree(copyBrett);
//    cout << sizeBTree(copyBrett) << endl;
//    assert(copyBrett == NULL);
